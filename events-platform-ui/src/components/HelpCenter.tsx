...
const SupportCard:React.FC<SupportCard>= ({objectSupport}) => {
  ...
  return (
    <div className={`max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6 flex items-center justify-between relative ${flexDirection}`}>
    ...
    <div>
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          <button
            className=" bg-black font-bold text-white px-5 py-2 mt-3
           rounded-md"
          >
            See more
          </button>
