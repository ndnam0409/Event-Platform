...
const SignInForm = () => {
	...
	return (
		<form noValidate={validated} onSubmit={handleSubmit}>
			...
			<div className="mb-4">
				<input type="checkbox" className="mr-2" id="remember-me" value=""/>
...
const Login = () => {
	return (
		<section className="ezy__signin6_udDNaPwh py-14 md:py-24 bg-white dark:bg-[#0b1727] text-indigo-900 dark:text-white">
